...
#define KNOT_LEN  1350			//mm
#define LOW_LIMIT 1500 			//Bag low limit in mm (note Knot length already taken into account)
...
#define long_flush	900		//encoder pulses: bag length used mm = pulses_in / bag_used_constant;
#define short_flush 900		//encoder pulses: bag length used mm = pulses_in / bag_used_constant;
